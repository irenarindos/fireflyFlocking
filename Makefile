...
HFILES 	= Matrix.${H} Vector.${H} Utility.${H} Camera.${H} flock.${H} boid.${H}
OFILES 	= Matrix.o Vector.o Utility.o Camera.o flock.o boid.o 
PROJECT = FlockingSystem
